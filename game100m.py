...
class Game100m:
    ...
    def __init__(self):
        ...
        self._mousepos = (0, 0)
        self._LEFT = 1
        self._players=[player.Player([pygame.image.load("img/muñecajo.png").convert_alpha(),pygame.image.load("img/muñecajo2.png").convert_alpha()],0,215,10, [pygame.K_l]), \
        player.Player([pygame.image.load("img/muñecajo.png").convert_alpha(),pygame.image.load("img/muñecajo2.png").convert_alpha()],0,285,10,[pygame.K_m]), \
        player.Player([pygame.image.load("img/muñecajo.png").convert_alpha(),pygame.image.load("img/muñecajo2.png").convert_alpha()],0,355,10,[pygame.K_x]), \
        player.Player([pygame.image.load("img/muñecajo.png").convert_alpha(),pygame.image.load("img/muñecajo2.png").convert_alpha()],0,425,10,[pygame.K_a])]
